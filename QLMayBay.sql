...
-- Lưu ý: Đây là ví dụ minh họa sử dụng CURSOR. Để chạy, copy đoạn code dưới đây vào SQL query window
 ...
 END;
 GO
ALTER TABLE CHUYENBAY DROP CONSTRAINT CHK_CB_TRANGTHAI;
ALTER TABLE CHUYENBAY ADD CONSTRAINT CHK_CB_TRANGTHAI 
CHECK (TRANGTHAI IN (N'Đang bay', N'Chờ bay', N'Đã hạ cánh', N'Hủy', N'Đúng giờ'));
